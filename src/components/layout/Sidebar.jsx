...
export default function Sidebar() {
  ...
  // โครงสร้างการประเมิน (/admin/clo, /admin/assessment-items, /admin/item-clo), กรอกคะแนน+ผลบรรลุ CLO
  // (/admin/course-grading หน้าใหม่) - ไม่ได้บล็อก route เอง แค่เอาออกจากเมนู แอดมินพิมพ์ URL ตรงเข้าไป
  // ได้เหมือนเดิมถ้าจำเป็น (ดูการสำรวจก่อนงานนี้ที่ยืนยันว่าไม่มีความสามารถอะไรเสียไปแล้ว)
  const navItems = [
    {
      to: "/",
