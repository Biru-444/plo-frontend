...
export default function Sidebar() {
  ...
  // เป็นทางเลือกของแอดมินตรงนี้ ถูกเปลี่ยนเป็นบล็อก admin แล้ว (เป็นงานของอาจารย์เท่านั้น ดู blockAdmin ใน
  // App.jsx) แอดมินจึงไม่มีทางกรอกคะแนน/ดูผลบรรลุ CLO ได้เองอีกต่อไปไม่ว่าทางไหน - เป็นการตัดสินใจตั้งใจ
  // ของผู้ใช้ ไม่ใช่ความสามารถที่หายไปโดยไม่ได้ตั้งใจ
  const navItems = [
    {
      to: "/",
