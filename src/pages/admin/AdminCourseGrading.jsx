...
/**
 * เดิมเป็นหน้าแอดมินสำหรับ "กรอกคะแนน" + "ผลบรรลุ CLO" ของวิชาที่เปิดสอนหนึ่งๆ - แทนที่ 2 ใน 4 แท็บของ
 ...
 *
 * **เปลี่ยน (2026-09-25)**: กรอกคะแนน/ผลบรรลุ CLO ถูกกำหนดให้เป็นงานของอาจารย์เท่านั้น (อาจารย์ใช้
 * /course-workspace เป็นหลักอยู่แล้ว ครบกว่าเพราะมี 4 แท็บ ไม่ใช่แค่ 2 ของหน้านี้) — เอาการ์ดออกจาก
 * AdminHome.jsx ก่อน (รอบแรก, บล็อก admin ด้วย blockAdmin) แล้วลบ <Route path="/admin/course-grading">
 * ออกจาก App.jsx ทั้งหมดในรอบถัดมา (2026-09-25 รอบ 2) เพราะไม่มีเมนูไหนชี้มาที่นี่เลย ไฟล์นี้จึงไม่มี
 * route ให้เข้าถึงในระบบแล้ว ณ ตอนนี้ (เก็บไว้เผื่อกลับมาใช้ในอนาคต ไม่ได้ลบไฟล์)
 *
