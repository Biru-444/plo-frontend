 ...
 *
 * **เปลี่ยน (2026-09-25)**: กรอกคะแนน/ผลบรรลุ CLO ถูกกำหนดให้เป็นงานของอาจารย์เท่านั้น route นี้จึงบล็อก
 * admin แล้ว (ดู blockAdmin ใน App.jsx) เหลือไว้ในระบบเผื่ออาจารย์เข้าตรง URL แต่ไม่มีเมนูไหนชี้มาที่นี่
 * อีกต่อไป (เอาการ์ดออกจาก AdminHome.jsx แล้ว) - อาจารย์ใช้ /course-workspace เป็นหลักเหมือนเดิม (ครบกว่า
 * เพราะมี 4 แท็บ ไม่ใช่แค่ 2) หน้านี้จึงเป็น route ที่ไม่มีทางเข้าจริงจากเมนูใดๆ ในตอนนี้
 *
