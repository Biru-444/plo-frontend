 ...
 *          คะแนน/ผลบรรลุ CLO" ย้ายไปเป็นงานของอาจารย์เท่านั้น (route /admin/course-grading ถูกลบออกจาก
 *          App.jsx แล้วเช่นกัน - ดู AdminCourseGrading.jsx สำหรับรายละเอียด) และ "นำเข้ารายชื่อ" ยังมี
 *          การ์ดเดิมอยู่ในหมวด "เครื่องมือเสริม" ด้านล่างอยู่แล้ว ไม่ต้องมีซ้ำ
 *
 * เชื่อมกับ : ทุก item ใน SECTIONS ลิงก์ไปหน้า admin/* ที่ตรงกับ route ใน App.jsx (requireAdmin ทุก
 *             เส้นทาง) — "งานประเมิน" (/admin/assessment-items), "งานประเมิน-CLO Mapping"
 *             (/admin/item-clo) ไม่มีการ์ดในหน้านี้ (2026-09-25) แต่ route ยังอยู่ เข้าได้ด้วย URL ตรง
 *             เท่านั้น (ตัดสินใจร่วมกับผู้ใช้แล้วว่าไม่ต้องหาที่ทางอื่นให้) - "การเปิดสอน"
 *             (/admin/course-offerings) เคยเป็นแบบเดียวกันแต่ย้ายกลับมาไว้ท้าย "เครื่องมือเสริม" แล้ว
 *             (2026-09-25 รอบ 2)
 *
...
const SECTIONS = [
  ...
  },
  {
    ...
    tooltip:
      "นำเข้าข้อมูลจาก มคอ.2 / มคอ.3 ด้วย AI (ตรวจสอบก่อนบันทึก), จัดแผนการศึกษา, นำเข้ารายชื่อนักศึกษาจากไฟล์ Excel และเปิดสอนรายวิชาพร้อมกำหนดผู้สอน",
    items: [
      {
