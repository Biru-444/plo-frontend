...
/**
 * หน้า "ภาพรวม PLO ทั้งหลักสูตร" (route /dashboard และหน้าแรกของ admin) - แสดง % นักศึกษาบรรลุ PLO
 * ครบทุกข้อ พร้อมการ์ดสรุปแยกตาม PLO แต่ละข้อ กรอง/เลือกหลักสูตร-รุ่นผ่าน URL query param เสมอ
 * (ไม่ใช่ local state) เพื่อให้กดเข้าดูรายละเอียดแล้วกดกลับ ตัวกรองเดิมยังอยู่
 */
